  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="relative z-10 px-6 pb-12 pt-28 md:px-16 lg:px-24">
        ...
        <motion.div
          className="mt-8 h-px w-24 origin-left bg-gold/40"
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
              ...
              return (
                ...
                >
                  <Link to={detailPath} className="block">
                    <div className="relative aspect-[16/10] overflow-hidden">
                      ...
                      <div className="absolute bottom-3 left-3 flex gap-2">
                        <span className="rounded-sm bg-gold/90 px-2.5 py-1 font-body text-[10px] font-bold uppercase tracking-wider text-primary-foreground">
                          {editorial.content_tier}
                        </span>
                        <span className="rounded-sm bg-background/80 px-2.5 py-1 font-body text-[10px] font-bold uppercase tracking-wider text-foreground backdrop-blur-sm">
                          {editorial.category}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="flex flex-1 flex-col p-5">
                    ...
                    <Link to={detailPath}>
                      <h2 className="mt-3 font-display text-lg font-bold leading-snug text-foreground transition-colors group-hover:text-gold">
                        {editorial.headline}
                      </h2>
                    </Link>

                    <p className="mt-2 line-clamp-3 flex-1 font-body text-sm leading-relaxed text-muted-foreground">
                      {editorial.cultural_significance}
                    </p>

                    <Link
                      to={detailPath}
                      className="mt-4 inline-flex items-center gap-1.5 font-body text-xs font-medium uppercase tracking-[0.15em] text-gold transition-colors hover:text-foreground"
                    >
                      Read {isPremium ? "Premium Feature" : "Editorial"}
