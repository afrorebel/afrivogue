...
const SEARCH_QUERIES: Record<string, string[]> = {
  Fashion: [
    "African fashion runway 2025 2026 editorial",
    "Lagos fashion week lookbook",
    "Afrofuturism fashion editorial photography",
    "African designer haute couture collection",
    "African print contemporary fashion styling",
  ],
  Beauty: [
    "African beauty editorial photography 2025",
    "melanin beauty campaign luxury",
    "Afrocentric beauty trends makeup artistry",
    "natural hair editorial styling Africa",
    "African skincare beauty photography",
  ],
  Art: [
    "contemporary African art installation 2025",
    "African diaspora visual art exhibition",
    "Afrofuturism digital art illustration",
    "African sculpture modern gallery",
    "Pan-African contemporary art photography",
  ],
  Design: [
    "African interior design luxury modern",
    "African textile pattern design contemporary",
    "African architecture modern minimalist",
    "African graphic design branding aesthetic",
    "African jewelry design artisan luxury",
  ],
  "Street Style": [
    "Lagos street style fashion photography",
    "Accra street fashion editorial",
    "Johannesburg street style 2025",
    "Nairobi street fashion photography",
    "African streetwear culture editorial",
  ],
  Culture: [
    "African cultural festival photography 2025",
    "African music culture fashion style",
    "African dance performance visual art",
    "African heritage fashion modern interpretation",
    "Pan-African cultural movement editorial",
  ],
};
